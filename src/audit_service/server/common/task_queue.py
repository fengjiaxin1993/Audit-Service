...
from audit_service.server.db.repository.audit_result_repository import batch_add_audit_results, update_audit_result
from audit_service.server.db.repository.task_repository import (
    get_task_by_id,
    update_task
)
from audit_service.server.db.repository.contract_repository import get_contract_by_id, update_contract
from audit_service.server.db.repository.audit_rule_repository import list_audit_rules
from audit_service.server.common.file_tools import save_ocr_result, load_cached_ocr_result, ensure_cache_dir
from audit_service.server.ocr.ocr_extract import process_file_ocr_by_path
from audit_service.server.audit.audit_graph import AuditRule, create_graph, GLOBAL_AUDIT_GRAPH
